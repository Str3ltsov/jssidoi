...
@section('content')
    ...
    @endif
    <x-admin.paginated_table :paginated="$reviews">
        <x-slot:header_right>
            <a href='{{ route('jssi.admin.reviews.create') }}' class="btn btn-success">Add new</a>
        </x-slot:header_right>
        ...
        <x-slot:tbody_content>
            @foreach ($reviews as $review)
                <tr>
                    ...
                    <td><a href="{{ route('jssi.admin.reviews.edit', $review->id) }}" class="btn btn-outline-success"><i
                                class="fas fa-edit"></i></a>
                        <button type="button" class="btn btn-outline-danger deleteBtn" data-id={{ $review->id }}
                            data-name="{{ $review->article->title }}"data-toggle="modal" data-target="#deleteCountry"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete review for article <span id="modal-country_name"></span>?
                    <input type="hidden" id="category" name="category_id">
                </div>
                <div class="modal-footer">
                    <form action="{{ route('jssi.admin.reviews.destroy', 'id') }}" method="post">
                        @csrf
                        @method('DELETE')
