    ...
    <div class="bg-white p-4 border-1 shadow-sm mt-4 rounded-1">
        ...
        @forelse($articles as $article)
            ...
            <p>
                ...
                <br>
                Kavan, �.; Kazanský, R.; Nečas, P. 2020. Identifying risks in selected social facilities when emergencies
                arise,
        ...
        <div class="row text-center mt-3">
            <div class="col-lg-12">
                Page {{ $articles->currentPage() }} of {{ $articles->lastPage() }}, showing {{ count($articles) }} records
                out of {{ $articles->total() }} total
